...
CREATE TABLE IF NOT EXISTS users (
  ...
  CONSTRAINT chk_users_role CHECK (role IN ('admin', 'manager', 'resident', 'guest')),
...
CREATE TABLE IF NOT EXISTS tickets (
  ...
  CONSTRAINT chk_tickets_category CHECK (category IN ('maintenance', 'complaint', 'request', 'emergency', 'other')),
